      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-blue-100 text-sm">
            ...
            <li className="flex items-center gap-2"><Phone className="h-4 w-4"/> +251 0118 69 78 80</li>
            <li className="flex items-center gap-2"><Mail className="h-4 w-4"/> info@belimunojobs.com</li>
          </ul>
        </div>
        <div>
