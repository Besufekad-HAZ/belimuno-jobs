      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-blue-100 text-sm leading-6">
            HR outsourcing and recruiting partner connecting talent with opportunities across Ethiopia since 2011.
        ...
        <div>
          ...
          <ul className="space-y-2 text-blue-100 text-sm">
            <li className="flex items-start gap-2"><MapPin className="h-4 w-4 mt-0.5"/> Addis Ababa, Ethiopia</li>
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4"/>
              <a href="tel:+251118697880" className="hover:text-white transition-colors">+251 0118 69 78 80</a>
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-4 w-4"/>
              <a href="mailto:info@belimunojobs.com" className="hover:text-white transition-colors">info@belimunojobs.com</a>
            </li>
            <li className="flex items-center gap-2">
              <Send className="h-4 w-4"/>
              <a href="https://t.me/belimunojobs" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">@belimunojobs</a>
            </li>
          </ul>
        </div>
        <div>
