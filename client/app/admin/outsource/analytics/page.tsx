...
const BusinessAnalytics: React.FC = () => {
  ...
  const activeJobs = jobs.filter((j) => j.status === 'assigned' || j.status === 'in_progress');
      ...
      const mockTopPerformers: TopPerformer[] = [
        { id: '1', name: 'TechCorp Inc', type: 'client', value: 15000, metric: 'Total Spent' },
        { id: '2', name: 'John Smith', type: 'worker', value: 4.9, metric: 'Rating' },
        { id: '3', name: 'Global Solutions', type: 'client', value: 12500, metric: 'Total Spent' },
        { id: '4', name: 'Maria Garcia', type: 'worker', value: 4.8, metric: 'Rating' },
      ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Comprehensive insights into business performance and growth</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <span className={`text-sm ml-1 ${analytics?.revenue.trend === 'up' ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{analytics?.projects.active || 0}</p>
                <p className="text-sm text-gray-600 mt-1">
                  {formatPercentage(analytics?.projects.successRate || 0)} success rate
                </p>
              </div>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{analytics?.clients.active || 0}</p>
                <p className="text-sm text-gray-600 mt-1">
                  {formatPercentage(analytics?.clients.retention || 0)} retention
                </p>
              </div>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Worker Utilization</p>
                <p className="text-2xl font-bold text-gray-900">{formatPercentage(analytics?.workers.utilization || 0)}</p>
                <p className="text-sm text-gray-600 mt-1">
                  ⭐ {analytics?.workers.averageRating?.toFixed(1) || 0}/5 avg rating
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Project Volume</h3>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-900">
                  {formatCurrency(analytics?.performance.averageProjectValue || 0)}
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-900">
                  {formatCurrency(analytics?.performance.clientAcquisitionCost || 0)}
                </p>
              </div>
            </div>
          </Card>
                ...
                <div key={performer.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-bold ${
                      performer.type === 'client' ? 'bg-blue-600' : 'bg-green-600'
                    }`}>
                      {idx + 1}
                    </div>
                    <div>
                  ...
                  <div className="text-right">
                    ...
                    <Badge variant={performer.type === 'client' ? 'info' : 'success'} size="sm">
                      {performer.type}
                    </Badge>
                  </div>
                </div>
