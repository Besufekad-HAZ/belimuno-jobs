...
const register = async (req, res, next) => {
  try {
    ...
    if (profile) {
      ...
      if (profile.bio) userData.profile.bio = profile.bio;
      if (profile.profession) userData.profile.profession = profile.profession;
      if (profile.experience) userData.profile.experience = profile.experience;

      // Handle address
      if (profile.address) {
        userData.profile.address = {};
        if (profile.address.city)
          userData.profile.address.city = profile.address.city;
        // Set default country
        userData.profile.address.country = "Ethiopia";
      }
    }
